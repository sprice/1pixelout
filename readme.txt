...
such as autostart and loop and ID3 tag integration.

== Installation ==

1. Extract the contents of the archive
2. Upload the contents of the audio-player folder to your 'wp-content/plugins' folder
3. Log in to your WordPress admin and got to the 'Plugins' section. You should now see Audio Player in the list of available plugins
4. Activate the plugin by clicking the 'activate' link
5. Now go to the 'Options' section and select 'Audio Player' where you can configure the plugin
...
= Can I place Audio Player in the sidebar? =

No. The player only works within posts and pages.
